...
import com.onthi.demau2_sqlite.NVVT;
...
public class Spinner1Adapter extends BaseAdapter {
    ...
    public Spinner1Adapter(@NonNull Activity context, List<NhanVien> nhanViens, int textViewItemNameID, int textViewItemID, int listItemLayoutResource) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        textViewItemName.setText(nhanVien.getTenNV());
